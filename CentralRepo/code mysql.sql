...
DELIMITER //
CREATE FUNCTION FUNC_SALT() RETURNS VARCHAR(32)
BEGIN
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE PRC_TIM_CHUYENBAY (IN diem_di VARCHAR(40), IN diem_den VARCHAR(40), IN ngay_di DATE)
BEGIN
